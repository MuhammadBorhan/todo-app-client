    ...
    return (
        <div className='px-12'>
            <div className='mt-4 py-5'>
                ...
                <div>
                    <Link to='/todo'><button className="btn btn-gost mt-4 ml-0 md:ml-36">Add New Task</button></Link>
                    {
                        tasks.map((task) => <div key={task._id} task={task} className="overflow-x-auto lg:w-3/4 mx-auto">
                                ...
                                <tbody>
                                    <tr className=''>
                                        ...
                                        <td className='text-right'>
                                            <Link to={`singletask/${task._id}`}><button className="btn btn-primary">Edit</button></Link>
                                        </td>
                                        <td onClick={() => handleDelete(task._id)} className='text-right text-2xl text-red-600 font-bold cursor-pointer'><button className="btn btn-error  font-bold">Delete</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>)
